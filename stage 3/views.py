    ...
    if 'user' in session and session['person_type'] == 'student':
        ...
        for teacher in teachers:
           for doc in teacher.stream():
              ...
              attendances_dict[i]=[subjectname,teachername,count_str,conducted,percentage_str]
              indexes.append(i)
              i=i+1
...
def teacher_manage_attendance():
    if request.method == 'GET':
        ...
        flash('Attendances updated successfully', 'info')
        return redirect('/teacher_dashboard')
        ...
        for student in students:
           if(student.id!="lectures"):
              ...
              if conducted_int != 0:
                 ...
                 percentage=100
              percentage_str=str(percentage)+"%"
              attendances_dict[i]=[name,count_str,percentage_str]
              indexes.append(i)
              i=i+1
